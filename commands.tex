...
\NewDocumentCommand{\headerfull}{mmmmm}{
  ...
  \grid{1}{8}{1}{\fontsm\hspace{\fill}\LaTeX}
  \grid{2}{4}{0}{\fontmd\texttt{#2}\hspace{\fill}\texttt{#4}}
  \grid{2}{4}{0}{\fontmd\texttt{#3}\hspace{\fill}\texttt{#5}}
  \grid{2}{2}{0}{\rule{2\TPHorizModule}{0.5pt}}
}
